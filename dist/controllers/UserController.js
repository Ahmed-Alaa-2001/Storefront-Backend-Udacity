...
exports.ShowOneController = exports.ShowAllController = exports.EditController = exports.DeleteOneController = exports.DeleteAllController = exports.postLogIn = exports.postSignUp = void 0;
...
var DeleteOneController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleteOne, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                return [4, userModel.deleteById(id)];
            case 1:
                deleteOne = _a.sent();
                res.json({
