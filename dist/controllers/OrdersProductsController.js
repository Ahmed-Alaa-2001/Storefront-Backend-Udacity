...
exports.ShowOneController = exports.ShowAllController = exports.EditController = exports.DeleteOneController = exports.CreateController = void 0;
...
var DeleteOneController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, orderProductModel.delete(req.body.orderId, req.body.productId)];
            case 1:
                orderProduct = _a.sent();
                res.json({
...
var ShowAllController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var orderProducts, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, orderProductModel.showallProducts(req.params.id)];
            case 1:
...
var ShowOneController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, orderProductModel.showProduct(req.body.orderId, req.body.productId)];
            case 1:
                orderProduct = _a.sent();
                res.json({
